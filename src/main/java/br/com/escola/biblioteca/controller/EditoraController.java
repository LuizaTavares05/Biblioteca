...
@Tag(name = "Editoras", description = "API responsavel pelo gerenciamento de editoras")
public class EditoraController {
        ...
        @Operation(summary = "Cadastrar editora", description = "Realiza o cadastro de uma nova editora")
        ...
        @Operation(summary = "Listar editoras", description = "Retorna todas as editoras cadastradas")
        @ApiResponses(value = {
        ...
        @Operation(summary = "Atualizar editora", description = "Atualização de uma editora existente")
