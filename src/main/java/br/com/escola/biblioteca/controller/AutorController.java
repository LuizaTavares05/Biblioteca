...
@Tag(name = "Autores", description = "API responsável pelo gerenciamento de autores")
...
public class AutorController {
    ...
    @Operation(summary = "Cadastrar autor", description = "Realiza o cadastro de um novo autor")
    ...
    @Operation(summary = "Deletar autor", description = "Remove um autor pelo ID")
